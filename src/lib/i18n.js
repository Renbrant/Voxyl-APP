...
const translations = {
  ...
  deleteStep1Title: { pt: 'Excluir sua conta do Voxyl?', en: 'Delete your Voxyl account?' },
  deleteStep1Body: { pt: 'Esta ação exclui permanentemente sua conta do Voxyl e os dados pessoais associados a ela.', en: 'This permanently deletes your Voxyl account and the personal data associated with it.' },
  deleteStep1Warning: { pt: 'Esta ação não pode ser desfeita.', en: 'This action cannot be undone.' },
  ...
  deleteStep3Body: { pt: 'Digite a frase abaixo exatamente como mostrada para confirmar a exclusão permanente.', en: 'Type the phrase below exactly as shown to confirm permanent deletion.' },
  deleteGiveUp: { pt: 'Cancelar exclusão', en: 'Cancel deletion' },
  deleteTypeLabel: { pt: 'Digite para confirmar', en: 'Type to confirm' },
  deleteDeleting: { pt: 'Excluindo...', en: 'Deleting...' },
  deleteConfirmFinal: { pt: 'Excluir permanentemente', en: 'Delete permanently' },
  deleteError: { pt: 'Não foi possível concluir a exclusão. Sua conta não foi reportada como excluída. Tente novamente.', en: 'Deletion could not be completed. Your account was not reported as deleted. Please try again.' },
