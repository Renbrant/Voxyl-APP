...
const translations = {
  ...
  feedContinueListeningLoading: { pt: 'Carregando episódios em andamento...', en: 'Loading episodes in progress...' },
  feedContinueListeningError: { pt: 'Não foi possível carregar seu progresso.', en: 'Could not load your playback progress.' },
  feedContinueListeningEmpty: { pt: 'Nada para continuar agora', en: 'Nothing to continue right now' },
  feedContinueListeningEmptyHint: { pt: 'Quando você parar um episódio no meio, ele aparecerá aqui.', en: 'When you stop an episode partway through, it will appear here.' },
  feedResume: { pt: 'Continuar', en: 'Resume' },
  feedPause: { pt: 'Pausar', en: 'Pause' },
  ...
  feedHideListeningHistory: { pt: 'Ocultar histórico de reprodução', en: 'Hide listening history' },
  feedListeningHistoryTitle: { pt: 'Histórico de reprodução', en: 'Listening history' },
  ...
  // People
  peopleSubtitle: { pt: 'Sua comunidade no Voxyl', en: 'Your Voxyl community' },
  peopleSearchPlaceholder: { pt: 'Buscar pessoas...', en: 'Search people...' },
  peopleSearchResults: { pt: 'Resultados da busca', en: 'Search results' },
  peopleFollowing: { pt: 'Seguindo', en: 'Following' },
  peopleFollowingHint: { pt: 'Pessoas que você acompanha', en: 'People you follow' },
  peopleFollowers: { pt: 'Seguidores', en: 'Followers' },
  peopleFollowersHint: { pt: 'Pessoas que acompanham você', en: 'People who follow you' },
  peopleRequests: { pt: 'Solicitações', en: 'Requests' },
  peopleRequestsHint: { pt: 'Pedidos aguardando sua aprovação', en: 'Requests waiting for your approval' },
  peopleRequestsAttention: { pt: 'Precisa da sua atenção', en: 'Needs your attention' },
  peopleSuggestions: { pt: 'Sugestões', en: 'Suggestions' },
  peopleSuggestionsHint: { pt: 'Pessoas que você pode querer seguir', en: 'People you may want to follow' },
  peopleSuggestionsSubset: { pt: 'Esta lista mostra um subconjunto recente de candidatos elegíveis.', en: 'This list shows a recent subset of eligible candidates.' },
  peopleNoFollowing: { pt: 'Você ainda não segue ninguém', en: 'You are not following anyone yet' },
  peopleNoFollowers: { pt: 'Você ainda não tem seguidores', en: 'You do not have followers yet' },
  peopleNoRequests: { pt: 'Nenhuma solicitação aguardando você', en: 'No requests are waiting for you' },
  peopleNoSuggestions: { pt: 'Nenhuma sugestão disponível agora', en: 'No suggestions are available right now' },
  peopleSummaryError: { pt: 'Não foi possível carregar seu resumo social.', en: 'Could not load your social summary.' },
  peopleSectionError: { pt: 'Não foi possível carregar estas pessoas.', en: 'Could not load these people.' },
  peopleSignInTitle: { pt: 'Entre para ver sua comunidade', en: 'Sign in to see your community' },
  peopleSignInHint: { pt: 'Você ainda pode buscar perfis públicos sem entrar.', en: 'You can still search public profiles without signing in.' },
  ...
  discoverSearchSubtitle: { pt: 'Busque playlists e podcasts', en: 'Search playlists and podcasts' },
  discoverPlaylistsHeading: { pt: 'Descubra playlists', en: 'Discover playlists' },
  discoverPlaylistsHint: { pt: 'Veja playlists populares ou busque por título, descrição ou criador.', en: 'Browse popular playlists or search by title, description, or creator.' },
  discoverPodcastsHeading: { pt: 'Descubra podcasts', en: 'Discover podcasts' },
  discoverPodcastsHint: { pt: 'Busque por nome, tema ou assunto e refine os resultados.', en: 'Search by name, topic, or subject and refine the results.' },
  discoverNoPlaylistResults: { pt: 'Nenhuma playlist encontrada', en: 'No playlists found' },
  discoverTryAnotherSearch: { pt: 'Tente outro termo de busca.', en: 'Try another search term.' },
  discoverNoPlaylistsAvailable: { pt: 'Nenhuma playlist disponível agora', en: 'No playlists available right now' },
  discoverNoPlaylistsHint: { pt: 'Novas playlists públicas aparecerão aqui quando estiverem disponíveis.', en: 'New public playlists will appear here when available.' },
  ...
  playlistsLikedPodcasts: { pt: 'Podcasts curtidos', en: 'Liked podcasts' },
  ...
  blockLoadHiddenError: { pt: 'Não foi possível carregar seus bloqueios.', en: 'Could not load your block settings.', es: 'No se pudieron cargar tus bloqueos.' },
  blockRetry: { pt: 'Tentar novamente', en: 'Retry', es: 'Intentar de nuevo' },
  blockActionError: { pt: 'Não foi possível atualizar o bloqueio. Tente novamente.', en: 'Could not update the block. Please try again.', es: 'No se pudo actualizar el bloqueo. Inténtalo de nuevo.' },
  blockCreateError: { pt: 'Não foi possível bloquear este usuário agora. Tente novamente.', en: 'Could not block this user right now. Please try again.', es: 'No se pudo bloquear a este usuario ahora. Inténtalo de nuevo.' },
  blockLoadListError: { pt: 'Não foi possível carregar seus bloqueios.', en: 'Could not load your blocked users.', es: 'No se pudieron cargar tus usuarios bloqueados.' },
  blockUnblockError: { pt: 'Não foi possível desbloquear este usuário. Tente novamente.', en: 'Could not unblock this user. Please try again.', es: 'No se pudo desbloquear a este usuario. Inténtalo de nuevo.' },
  blockFollowRequestsError: { pt: 'Não foi possível carregar os pedidos com segurança.', en: 'Could not safely load follow requests.', es: 'No se pudieron cargar las solicitudes de forma segura.' },
  blockProfileUnavailable: { pt: 'Este perfil não está disponível.', en: 'This profile is unavailable.', es: 'Este perfil no está disponible.' },
  blockYouBlockedUser: { pt: 'Você bloqueou este usuário', en: 'You blocked this user', es: 'Bloqueaste a este usuario' },
  ...
  deleteStep1Body: { pt: 'Você está prestes a desativar permanentemente sua conta no Voxyl. Todos os seus dados pessoais serão removidos. Esta ação não pode ser desfeita.', en: 'You are about to permanently deactivate your Voxyl account. All your personal data will be removed. This action cannot be undone.' },
  deleteStep1Warning: { pt: 'Suas playlists permanecerão no app de forma anônima, sem nenhuma informação sua associada.', en: 'Your playlists will remain in the app anonymously, with no information associated with you.' },
  deleteStep1Confirm: { pt: 'Sim, quero desativar minha conta', en: 'Yes, I want to deactivate my account' },
  deleteStep1Cancel: { pt: 'Não, voltar', en: 'No, go back' },
  deleteStep2Title: { pt: 'Tem absoluta certeza?', en: 'Are you absolutely sure?' },
  deleteStep2Body: { pt: 'Serão removidos permanentemente: curtidas, histórico de reprodução, progresso dos episódios, seguidores, bloqueios e referências.', en: 'Permanently removed: likes, playback history, episode progress, follows, blocks and referrals.' },
  deleteStep2Warning: { pt: 'Esta ação é permanente. Não há como recuperar seus dados depois.', en: 'This action is permanent. There is no way to recover your data afterwards.' },
  ...
  deleteDeleting: { pt: 'Desativando...', en: 'Deactivating...' },
  deleteConfirmFinal: { pt: 'Desativar definitivamente', en: 'Deactivate permanently' },
  ...
  detailLoadingCachedEpisodes: { pt: 'Carregando episódios salvos', en: 'Loading saved episodes' },
  detailCachedEpisodesReady: { pt: 'Episódios salvos prontos', en: 'Saved episodes ready' },
  detailUpdatingEpisodes: { pt: 'Atualizando episódios', en: 'Updating episodes' },
  detailRefreshingEpisodes: { pt: 'Recarregando episódios', en: 'Refreshing episodes' },
  detailSomeFeedsFailed: { pt: 'alguns feeds falharam', en: 'some feeds failed' },
  detailAllEpisodesUpdated: { pt: 'Todos os episódios atualizados', en: 'All episodes updated' },
  detailEpisodesUpdatedWithFailures: { pt: 'Atualizado com falhas em feeds', en: 'Updated with feed failures' },
  detailUpdateFailedCachedAvailable: { pt: 'Falha ao atualizar; usando episódios salvos', en: 'Update failed; using saved episodes' },
  detailNoEpisodesAfterSync: { pt: 'Nenhum episódio encontrado após atualizar', en: 'No episodes found after updating' },
